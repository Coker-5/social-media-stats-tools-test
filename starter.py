...
def main():
    try:
        ...
        # 记录各任务执行结果
        results = {"douyin": run_douyin_task(browser), "xiaohongshu": run_xiaohongshu_task(browser),
                   "kuaishou": run_kuaishou_task(browser), "shipinhao": run_shipinhao_task(browser)}
